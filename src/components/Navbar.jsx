...
const AppNavbar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <BsNavbar expand="lg" className="bg-white border-bottom shadow-sm px-4 py-2 d-flex align-items-center">
      ...
      <Nav className="flex-grow-1 justify-content-center gap-4 fw-semibold">
        ...
        <NavLink to="/pricing" className="nav-link text-dark">Pricing</NavLink>
        <NavLink to="/contact" className="nav-link text-dark">Contact Us</NavLink>
        <Nav.Link href="/my-profile" onClick={() => setActiveTab('profile')}>My Profile</Nav.Link>
      </Nav>
